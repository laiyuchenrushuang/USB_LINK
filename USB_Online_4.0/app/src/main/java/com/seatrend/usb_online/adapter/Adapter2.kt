...
class Adapter2(private var mContext: Context? = null, private var mData: List<NewData.DATA_NEW>? = null) :
    RecyclerView.Adapter<Adapter2.MyHolder>() {
    ...
    fun setData(data: ArrayList<NewData.DATA_NEW>?) {
        this.mData = data
    ...
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): MyHolder {
        val view: View = LayoutInflater.from(mContext).inflate(R.layout.recyclerview2, parent, false)
    ...
    inner class MyHolder(view: View) : RecyclerView.ViewHolder(view) {
        var id: TextView = view.findViewById(R.id.seal_id)
        var lx: TextView = view.findViewById(R.id.seal_lx)
    ...
    interface Dback {
        ...
        fun getCurrentList(dataList:List<NewData.DATA_NEW>?)
    }
}